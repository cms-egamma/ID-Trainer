...
####Start here
#####################################################################
OutputDirName = 'PFElectronConfig_EB_lowpT' #All plots, models, config file will be stored here
...
CommonSel='(ele_pt > 5) & (ele_pt < 10) & (abs(scl_eta) < 1.442) & (abs(scl_eta) < 2.5)'
