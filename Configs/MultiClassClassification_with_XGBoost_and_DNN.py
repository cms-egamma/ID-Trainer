...
####Start here
#####################################################################
OutputDirName = 'MultiClassClassification_with_XGBoost_and_DNN' #All plots, models, config file will be stored here
...
Classes,ClassColors = ['IsolatedSignal','NonIsolated','QCD'],['#377eb8', '#ff7f00','#4daf4a'] #You can also add more than three
